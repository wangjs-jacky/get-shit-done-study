...
```bash
node "/Users/jiashengwang/jacky-github/get-shit-done-study/.opencode/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/jiashengwang/jacky-github/get-shit-done-study/.opencode/get-shit-done/bin/gsd-tools.cjs" validate health
```
