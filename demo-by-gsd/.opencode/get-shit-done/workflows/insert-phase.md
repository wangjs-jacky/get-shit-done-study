...
```bash
INIT=$(node "/Users/jiashengwang/jacky-github/get-shit-done-study/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/jiashengwang/jacky-github/get-shit-done-study/.opencode/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
