...
独立的研究命令。对于大多数工作流，使用 `/gsd:plan-phase`，它会自动集成研究。
</purpose>
...
- `## RESEARCH COMPLETE` — 显示摘要，提供：计划/深入研究/审查/完成
- `## CHECKPOINT REACHED` — 展示给用户，生成继续执行任务
- `## RESEARCH INCONCLUSIVE` — 显示尝试结果，提供：添加上下文/尝试不同模式/手动处理
